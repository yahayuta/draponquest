...
public class Shop {
    ...
    /**
     * Constructs a new Shop instance and initializes its inventory with default
     * items.
     */
    public Shop() {
        ...
        itemsForSale.add(new Item("Antidote", "Cures poison", "cure_poison", 15));
    }
     ...
     * The player's gold is checked, and if sufficient, the item is added to their
     * inventory.
     * 
     * @param item The Item the player wishes to buy.
     * @param game The main game instance, providing access to player's gold and
     *             inventory.
     ...
     * The item is removed from the player's inventory, and half its value is added
     * to their gold.
     * 
