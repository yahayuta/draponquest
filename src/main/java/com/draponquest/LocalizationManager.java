...
public class LocalizationManager {
    ...
    private static void initializeTextData() {
        ...
        // NPC Dialogue
        englishText.put("npc_soldier", "I am a soldier.@I guard the castle.E");
        englishText.put("npc_merchant", "Welcome to the shop!@We have fine goods.E");
        ...
        // NPC Dialogue
        japaneseText.put("npc_soldier", "私は兵士です。@城を守っています。E");
        japaneseText.put("npc_merchant", "いらっしゃいませ！@良い品揃っていますよ。E");
